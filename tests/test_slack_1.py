...
class TestSlackFunctions(unittest.TestCase):
    ...
    def test_slack_post_success(self, mock_chat_postMessage):
        # Arrange
    ...
    @patch('src.your_module.client.chat_postMessage')
    def test_slack_post_failure(self, mock_chat_postMessage):
        # Arrange
    ...
    def test_get_slack_user_id_success(self, mock_users_lookupByEmail):
        # Arrange
    ...
    @patch('src.your_module.client.users_lookupByEmail')
    def test_get_slack_user_id_failure(self, mock_users_lookupByEmail):
        # Arrange
