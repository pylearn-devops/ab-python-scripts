...
from your_module import slack_post, get_slack_user_id  # Update with the correct module path

class TestSlackFunctions(unittest.TestCase):

    @patch('your_module.requests.get')
    @patch('your_module.get_secret')
    @patch('your_module.client.chat_postMessage')
    def test_slack_post_success(self, mock_chat_postMessage, mock_get_secret, mock_requests_get):
        # Arrange
        mock_get_secret.return_value = 'fake_token'
        mock_requests_get.return_value.json.return_value = {'data': {'fake_secret': 'fake_token'}}
    ...
    @patch('your_module.get_secret')
    @patch('your_module.client.chat_postMessage')
    def test_slack_post_failure(self, mock_chat_postMessage, mock_get_secret, mock_requests_get):
        # Arrange
        mock_get_secret.return_value = 'fake_token'
        mock_requests_get.return_value.json.return_value = {'data': {'fake_secret': 'fake_token'}}
    ...
    @patch('your_module.requests.get')
    @patch('your_module.get_secret')
    @patch('your_module.client.users_lookupByEmail')
    def test_get_slack_user_id_success(self, mock_users_lookupByEmail, mock_get_secret, mock_requests_get):
        # Arrange
        mock_get_secret.return_value = 'fake_token'
        mock_requests_get.return_value.json.return_value = {'data': {'fake_secret': 'fake_token'}}
    ...
    @patch('your_module.get_secret')
    @patch('your_module.client.users_lookupByEmail')
    def test_get_slack_user_id_failure(self, mock_users_lookupByEmail, mock_get_secret, mock_requests_get):
        # Arrange
        mock_get_secret.return_value = 'fake_token'
        mock_requests_get.return_value.json.return_value = {'data': {'fake_secret': 'fake_token'}}
